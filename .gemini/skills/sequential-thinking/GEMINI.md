...
Optional scripts for deterministic validation/tracking (execute with `bun`):
- `.gemini/skills/sequential-thinking/scripts/process-thought.ts` - Validate & track thoughts with history
- `.gemini/skills/sequential-thinking/scripts/format-thought.ts` - Format for display (box/markdown/simple)
